...
export const HowItWorks = () => {
  const steps = [
    ...
    },
    {
      ...
      description: <>Once you've chosen your developer(s), we handle all legal, payroll, and onboarding processes. You start collaborating immediately — with a week free trial period.</>,
